  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Trade Card */}
        {message.trade && (
          <div className="mt-2 p-3 bg-card rounded-lg border max-w-sm">
            ...
            {message.trade.screenshot_url && (
              <img
                src={message.trade.screenshot_url}
                alt="Trade screenshot"
                className="mt-2 rounded-md max-h-48 object-cover cursor-pointer hover:opacity-90"
              />
            )}
          </div>
        )}
